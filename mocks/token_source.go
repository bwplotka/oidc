...
import oidc "github.com/Bplotka/oidc"
...
// OIDCTokenCtx provides a mock function with given fields: _a0
func (_m *TokenSource) OIDCTokenCtx(_a0 context.Context) (*oidc.Token, error) {
	ret := _m.Called(_a0)
